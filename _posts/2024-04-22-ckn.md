...
- The idea is that we first extract patches $$\mathbf{x}$$ from the image $$I_0$$.
...
- We can therefore compute the pooling operations. Note that gaussian linear pooling is defined as
$$
\begin{equation*}
