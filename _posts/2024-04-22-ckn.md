...
toc:
  ...
  - name: Convolutional Kernel Network in depth
          - name: Mathematical insights and computability
          - name: The Convolutional Kernel Network
  - name: CNN vs. CKN
          - name: Stoneage ML :mammoth:
          - name: Challenges
  - name: For the interesting reader :desktop_computer:
...
## For the interesting reader :desktop_computer:
