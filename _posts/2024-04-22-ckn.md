...
In this blogpost, we focused on the architecture and implementation of the Convolutional Kernel Network, which plays with convolutional representations in RKHSs. We take a look at its architecture and try to implement it *from scratch*, to better understand its ins and outs.
